...
from paypal.digitalgoods.conf import (POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT, 
    RECEIVER_EMAIL)
...
class PayPalPaymentsForm(forms.Form):
    ...
    """    
    CMD_CHOICES = (
        ("_express-checkout-in-context", "Pay with PayPal"), 
    )
    ...
    def __init__(self, button_type="digitalgoods", *args, **kwargs):
    ...
    def get_image(self):
        return {
            (True, self.DG): DG_IMAGE,
            (False, self.DG): DG_IMAGE,
...
class PayPalSharedSecretEncryptedPaymentsForm(PayPalEncryptedPaymentsForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        from paypal.digitalgoods.helpers import make_secret
...
class PayPalStandardBaseForm(forms.ModelForm):
    ...
    # PayPal dates have non-digitalgoods formats.
